...
func testMemListenerHTTP(t *testing.T, f func(t *testing.T, client *http.Client)) {
	ln := NewMemListener()
	defer ln.Close()
...
func testMemListenerHTTPSingle(t *testing.T, client *http.Client, content string) {
...
func TestMemListenerHTTPSingle(t *testing.T) {
	testMemListenerHTTP(t, func(t *testing.T, client *http.Client) {
		testMemListenerHTTPSingle(t, client, "request")
	})
}

func TestMemListenerHTTPSerial(t *testing.T) {
	testMemListenerHTTP(t, func(t *testing.T, client *http.Client) {
		for i := 0; i < 10; i++ {
			testMemListenerHTTPSingle(t, client, fmt.Sprintf("request_%d", i))
		}
	})
}

func TestMemListenerHTTPConcurrent(t *testing.T) {
	testMemListenerHTTP(t, func(t *testing.T, client *http.Client) {
